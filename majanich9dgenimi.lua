...
local Tab = Window:NewTab("POTIONS")
local Section = Tab:NewSection("Potions lvl 2")
Section:NewButton("Luck Potions 2", "ButtonInfo", function()
local args = {
	{
		id = 10047,
		count = 5
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("PotionMerge"):InvokeServer(unpack(args))
    print("Luckpotion2made!")
end)

Section:NewButton("Dmg Potions 2", "ButtonInfo", function()
local args = {
    {
        id = 10048,
        count = 5
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("PotionMerge"):InvokeServer(unpack(args))
    print("Dmgpotion2made!")
end)

Section:NewButton("Coins Potions 2", "ButtonInfo", function()
local args = {
    {
        id = 10048,
        count = 5
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("PotionMerge"):InvokeServer(unpack(args))
    print("Coinspotion2made!")
end)

local Section = Tab:NewSection("Potions lvl 3")
Section:NewButton("Luck Potions 3", "ButtonInfo", function()
local args = {
    {
        id = 10050,
        count = 5
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("PotionMerge"):InvokeServer(unpack(args))
    print("Luckpotion3made!")
end)

Section:NewButton("Dmg Potions 3", "ButtonInfo", function()
local args = {
    {
        id = 10051,
        count = 5
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("PotionMerge"):InvokeServer(unpack(args))
    print("Dmgpotion3made!")
end)

Section:NewButton("Coins Potions 3", "ButtonInfo", function()
local args = {
    {
        id = 10052,
        count = 5
